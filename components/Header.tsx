    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/20 shadow-sm py-3 px-8 border-b border-gray-200 backdrop-blur-md">
      <div className="container mx-auto flex justify-between items-center">
        ...
        {isLoggedIn ? (
          ...
          <button
            onClick={onOpenModal}
            className="bg-gradient-to-br from-purple-500 to-pink-600 cursor-pointer text-nowrap text-white font-bold py-2 px-6 rounded-lg shadow-lg hover:bg-blue-700 transition-colors duration-300"
          >
            Sign In
          </button>
        )}
